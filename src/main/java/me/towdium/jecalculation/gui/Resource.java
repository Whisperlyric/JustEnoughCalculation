...
public class Resource {
    public static final Identifier location = Identifier.fromNamespaceAndPath(
    ...
    public static final Resource BTN_DELETE_L_N = getIcon(13, 2);
    ...
    public static final ResourceGroup BTN_DELETE_L = new ResourceGroup(BTN_DELETE_L_N);
    ...
    protected Identifier rl;

    public Resource(int xPos, int yPos, int xSize, int ySize, Identifier rl) {
        this.xPos = xPos;
        this.yPos = yPos;
        this.xSize = xSize;
        this.ySize = ySize;
