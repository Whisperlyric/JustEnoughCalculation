...
public class CostList {
    ...
    public class Calculator {
        ...
        public Calculator() throws ArithmeticException {
            ...
            while (next != null) {
                ...
                if (count++ > 1000 && player != null) {
                    player.sendSystemMessage(Component.translatable("jecalculation.chat.max_loop"));
                    break;
                }
            }
        }
        ...
        private CostList getCurrent() {
            return procedure.isEmpty() ? CostList.this : procedure.getLast().one;
        }
